...
public class SurgicalAppointmentResourceIntegrationTest extends MainResourceControllerTest {
	...
	public void shouldUpdateTheSurgicalAppointment() throws Exception {
		...
		assertEquals(simpleDateFormat.parse("2017-05-11T10:20:00.000"),
		    simpleDateFormat.parse(surgicalAppointment.get("actualStartDatetime")));
		assertEquals(simpleDateFormat.parse("2017-05-11T11:30:00.000"),
		    simpleDateFormat.parse(surgicalAppointment.get("actualEndDatetime")));
