...
public class SurgicalAppointmentAttributeResource extends DelegatingSubResource<SurgicalAppointmentAttribute, SurgicalAppointment, SurgicalAppointmentResource> {
    ...
    @Override
    protected void delete(SurgicalAppointmentAttribute surgicalAppointmentAttribute, String s, RequestContext requestContext) throws ResponseException {
    ...
    @Override
    public void purge(SurgicalAppointmentAttribute surgicalAppointmentAttribute, RequestContext requestContext) throws ResponseException {
        throw new ResourceDoesNotSupportOperationException("Purge not supported on SurgicalAppointmentAttribute resource");
    }
    ...
    @Override
    public PageableResult doGetAll(SurgicalAppointment surgicalAppointment, RequestContext requestContext) throws ResponseException {
