...
public class SurgicalBlockDAOTest extends BaseModuleWebContextSensitiveTest {
	...
	@Test
	public void shouldNotGetOverlappingSurgicalBlocksWhichStartedAndEndedBeforeTheDateRangeForAGivenLocation()
	...
	@Test
	public void shouldGetAllOverlappingSurgicalBlocksForDifferentDateRangeForTheSameProviderAndLocationForAnExistingSurgicalBlock()
	        throws Exception {
	...
	@Test
	public void shouldGetAllOverlappingSurgicalBlocksForDifferentDateRangeForADifferentProviderForAnExistingSurgicalBlock()
	        throws Exception {
	...
	@Test
	public void shouldGetAllOverlappingSurgicalBlocksForDifferentDateRangeLocationAndProviderForAnExistingSurgicalBlock()
	        throws Exception {
		Date startDatetime = simpleDateFormat.parse("2017-04-25 11:00:00");
	...
	@Test
	public void shouldGetAllOverlappingSurgicalBlocksForSameDateRangeAndProviderForDifferentLocationForAnExistingSurgicalBlock()
	        throws Exception {
	...
	@Test
	public void shouldGetAllOverlappingSurgicalBlocksForSameDateRangeAndLocationForDifferentProviderForAnExistingSurgicalBlock()
	        throws Exception {
		Date startDatetime = simpleDateFormat.parse("2017-04-24 10:00:00");
		Date endDatetime = simpleDateFormat.parse("2017-04-24 11:30:00");
		Provider provider = Context.getProviderService().getProvider(2);
	...
	@Test
	public void shouldReturnOverlappingSurgicalAppointmentsFromTheOtherSurgicalBlocksForAPatientWhenStartedBeforeStartTimeAndEndedBeforeEndTime()
	        throws Exception {
		Date startDatetime = simpleDateFormat.parse("2017-04-24 10:00:00");
	...
	@Test
	public void shouldReturnOverlappingSurgicalAppointmentsFromTheOtherSurgicalBlocksForAPatientWhenStartedAfterStartTimeAndEndedAfterEndTime()
	        throws Exception {
	...
	@Test
	public void shouldReturnOverlappingSurgicalAppointmentsFromTheOtherSurgicalBlocksForAPatientWhenStartedAfterStartTimeAndEndedBeforeEndTime()
	        throws Exception {
		Date startDatetime = simpleDateFormat.parse("2017-04-24 14:00:00");
	...
	@Test
	public void shouldReturnOverlappingSurgicalAppointmentsFromTheOtherSurgicalBlocksForAPatientWhenStartAndEndTimesAreEqualAsThatOfTheBlock()
	        throws Exception {
	...
	@Test
	public void shouldReturnOverlappingSurgicalAppointmentsFromTheOtherSurgicalBlocksForAPatientWhenStartAndEndTimesAreBeforeTheStartTimeOfTheSameBlock()
	        throws Exception {
		Date startDatetime = simpleDateFormat.parse("2017-04-24 10:00:00");
		Date endDatetime = simpleDateFormat.parse("2017-04-24 12:00:00");
		Patient patient = Context.getPatientService().getPatient(1);
	...
	@Test
	public void shouldReturnOverlappingSurgicalAppointmentsFromTheOtherSurgicalBlocksForAPatientWhenStartAndEndTimesAreAfterTheEndTimeOfTheSameBlock()
	        throws Exception {
	...
	@Test
	public void shouldReturnOverlappingSurgicalAppointmentsFromTheOtherSurgicalBlocksForAPatientWhenUpdatingTheSurgicalBlockIfAnyOtherSurgicalBlocksConflicting()
	        throws Exception {
		Date startDatetime = simpleDateFormat.parse("2017-04-24 13:00:00");
		Date endDatetime = simpleDateFormat.parse("2017-04-24 15:00:00");
		Patient patient = Context.getPatientService().getPatient(1);
		...
		List<SurgicalAppointment> surgicalBlocks = surgicalBlockDAO
		        .getOverlappingSurgicalAppointmentsForPatient(startDatetime, endDatetime, patient, surgicalBlockId);
	...
	@Test
	public void shouldReturnOverllappingSurgicalBlocksAsZeroWhenNewSurgicalBlockStartingTimeIsEqualToEndTimeOfAnotherSurgicalBlock()
	        throws Exception {
		Date startDatetime = simpleDateFormat.parse("2017-04-24 11:30:00");
		Date endDatetime = simpleDateFormat.parse("2017-04-24 12:00:00");
	...
	@Test
	public void shouldReturnOverllappingSurgicalBlocksAsZeroWhenNewSurgicalBlockEndingTimeIsEqualToStartOfAnotherSurgicalBlock()
	        throws Exception {
		Date startDatetime = simpleDateFormat.parse("2017-04-24 17:00:00");
	...
	@Test
	public void shouldReturnSurgicalBlocksWhichAreAcrossMultipleDaysIfWePassActiveBlocksAsTrue() throws Exception {
	...
	@Test
	public void shouldReturnEmptySurgicalBlocksForGivenDateRangeWhenThereAreNoSurgicalBlocksExistIfWePassActiveBlocksAsTrue()
	        throws Exception {
