...
public class SurgicalAppointmentServiceImplTest {
    ...
    public void shouldSaveTheSurgicalAppointmet() throws ParseException {
        ...
        when(surgicalBlockDAO.getOverlappingSurgicalAppointmentsForPatient(any(Date.class), any(Date.class), eq(patient), eq(1))).thenReturn(new ArrayList<SurgicalAppointment>());
    ...
    @Test
    public void shouldValidateForOverlappingSurgicalAppointmnetsforthePatientBeforeUpdatingSurgicalAppointment() throws Exception {
        ...
        when(surgicalBlockDAO.getOverlappingSurgicalAppointmentsForPatient(startDatetime, endDatetime, patient, 1)).thenReturn(new ArrayList<SurgicalAppointment>());

        surgicalAppointmentService.save(surgicalAppointment);
        verify(surgicalBlockDAO, times(1)).getOverlappingSurgicalAppointmentsForPatient(surgicalBlock.getStartDatetime(), surgicalBlock.getEndDatetime(), surgicalAppointment.getPatient(), surgicalBlock.getId());
    }
    ...
    public void shouldThrowExceptionIfPatientishavingOverlappingSurgicalAppointmentsBeforeSaving() throws Exception {
        ...
        when(surgicalBlockDAO.getOverlappingSurgicalAppointmentsForPatient(startDatetime, endDatetime, patient, 1)).thenReturn(overlappingSurgicalAppointments);
