...
public class SurgicalAppointmentAttribute extends BaseOpenmrsData implements java.io.Serializable, Comparable<SurgicalAppointmentAttribute> {
	...
	public static class DefaultComparator implements Comparator<SurgicalAppointmentAttribute> {
		...
		public int compare(SurgicalAppointmentAttribute saa1, SurgicalAppointmentAttribute saa2) {
			int retValue;
			if ((retValue = OpenmrsUtil.compareWithNullAsGreatest(saa1.getSurgicalAppointmentAttributeType(),
			    saa2.getSurgicalAppointmentAttributeType())) != 0) {
				return retValue;
			}
	...
	public boolean equals(Object o) {
		if (this == o)
			return true;
		if (!(o instanceof SurgicalAppointmentAttribute))
			return false;
		if (!super.equals(o))
			return false;
		...
		if (getId() != null ? !getId().equals(that.getId()) : that.getId() != null)
			return false;
		if (getSurgicalAppointmentAttributeType() != null
		        ? !getSurgicalAppointmentAttributeType().equals(that.getSurgicalAppointmentAttributeType())
		        : that.getSurgicalAppointmentAttributeType() != null)
			return false;
	...
	public int hashCode() {
		...
		result = 31 * result
		        + (getSurgicalAppointmentAttributeType() != null ? getSurgicalAppointmentAttributeType().hashCode() : 0);
